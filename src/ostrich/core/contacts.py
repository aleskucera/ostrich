...
def _shape_to_local_idx(
    ...
    """Map Newton's flat shape index to the column of OstrichModel's (W, S+G)
...
def batch_contact_data_kernel(
    ...
    # toward shape1 (A-to-B). Ostrich's contact/friction kernels were written for
...
class OstrichContacts:
    ...
    def load_contact_data(
        self, contacts: Contacts, ostrich_model: OstrichModel, data: EngineData, dims: EngineDimensions
    ):
