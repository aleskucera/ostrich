...
class OstrichModelBuilder(newton.ModelBuilder):
    """
    A custom ModelBuilder for Ostrich that adds necessary attributes for PID control and joint modes.
    """

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self._add_ostrich_custom_attributes()

    def _add_ostrich_custom_attributes(self):
    ...
    def _backfill_empty_custom_attributes(
        ...
        Ostrich downstream code assumes registered attributes (e.g. ``joint_dof_mode``)
