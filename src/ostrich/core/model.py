...
class OstrichModel:
    def __init__(self, model: Model) -> None:
        ...
        assert self.num_global_bodies == 0, (
            f"OstrichModel does not yet support global bodies (got {self.num_global_bodies})."
        )
        assert self.num_global_joints == 0, (
            f"OstrichModel does not yet support global joints (got {self.num_global_joints})."
        )
        ...
        self.shape_stribeck_lateral_only = self._broadcast_shape_array(model.stribeck_lateral_only)
