...
class BaseSimulator(ABC):
    """
    The foundational class for Ostrich simulations.
    ...
    def __init__(
        ...
        self.builder = OstrichModelBuilder()
    ...
    def init_state_fn(
        ...
        """
        Initialization hook for Ostrich engine.
        """
    ...
    def _single_physics_step(self, step_num: int):
        ...
        prof = self.solver.profiler if isinstance(self.solver, OstrichEngine) else None
