"""Stacked-boxes stability benchmark — Ostrich (Newton/Warp, forward only).
...
Usage:
    python examples/comparison/stacked_boxes/ostrich.py \
        --save examples/comparison/stacked_boxes/results/ostrich.json
"""
import argparse
import json
import os
...
def run_one(dt: float, engine_config: OstrichEngineConfig) -> dict:
...
def main():
    ...
    # Match Hydra defaults from examples/conf/engine/ostrich.yaml
