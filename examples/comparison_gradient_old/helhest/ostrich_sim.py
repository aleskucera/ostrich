"""Helhest trajectory optimization using Ostrich (Newton/Warp, implicit differentiation).
...
velocities. Gradients flow through Ostrich's custom implicit backward pass.
"""
import argparse
import json
import os
...
def main():
    ...
    if args.target_only and not args.save:
        args.save = "/tmp/helhest_ostrich.json"
