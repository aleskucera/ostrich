"""Helhest trajectory optimization — Ostrich, 100 parallel worlds.
...
Usage:
    python examples/comparison/helhest_batch/ostrich_sim.py --save examples/comparison/helhest_batch/results/ostrich.json
"""
import argparse
import json
import os
...
class HelhestBatchOptimizer(OstrichDifferentiableSimulator):
    def __init__(
        self,
        sim_config,
        render_config,
