...
and uses the Ostrich implicit gradient to recover the true target velocity.
...
from ostrich.core.types import JointMode  # Need this for control modes
...
class PendulumControlOptimizer(OstrichDifferentiableSimulator):
    def __init__(
        self,
