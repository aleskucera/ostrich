"""Helhest scalability benchmark — Ostrich, variable number of worlds.

Usage:
    python examples/comparison/helhest_scalability/ostrich_sim.py --num-worlds 100 --save results/ostrich_100.json
"""
import argparse
import json
import os
