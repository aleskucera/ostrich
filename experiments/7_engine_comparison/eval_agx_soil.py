...
turn-radius pairs; writes results/agx_soil.json.
"""
import json
import pathlib
import sys
...
results = {r["id"]: r for r in bridge.run_agx(jobs)}

out = {"engine": "agx_soil", "params": PARAMS, "dt": DT, "bags": {}, "turn": []}
...
with open(common.RESULTS_DIR / f"agx_soil{suffix}.json", "w") as f:
    json.dump(out, f, indent=1)
print(f"GT-mean {out['error_gt_mean']:.3f} m -> results/agx_soil.json")
