"""Ostrich dt stability sweep — obstacle traversal with calibrated params.
...
Usage:
    python examples/comparison_gradient/helhest/dt_sweep/sweep_ostrich.py
    python examples/comparison_gradient/helhest/dt_sweep/sweep_ostrich.py \
...
def main():
    ...
    print(f"Ostrich obstacle dt sweep — {args.num_trials} trial(s)")
    print(
