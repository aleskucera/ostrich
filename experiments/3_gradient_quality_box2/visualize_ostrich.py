"""Interactive GL visualisation of a single Ostrich optimisation trial.

Builds the same `HelhestJuniorBoxFinalPoseOptimizer` as `optimize_ostrich.py`
...
Usage:
    python experiments/3_gradient_quality_box2/visualize_ostrich.py
...
from optimize_ostrich import (HelhestJuniorBoxFinalPoseOptimizer, SplineAdam,
...
def main():
    ...
    # Match the same task stream as optimize_ostrich.py — draw `trial_index`+1
