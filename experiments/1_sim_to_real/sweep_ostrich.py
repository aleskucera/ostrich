"""Fast Ostrich sweep — single process, no subprocess, no model rebuild.
...
Usage:
    python examples/comparison_accuracy/helhest/sweep_ostrich_fast.py \
        --ground-truth results/helhest_2026_04_10-14_46_18.json

    python examples/comparison_accuracy/helhest/sweep_ostrich_fast.py \
        --ground-truth results/helhest_2026_04_10-14_46_18.json \
        --save results/sweep_ostrich_14_46_18.json
"""
import argparse
import dataclasses
import json
