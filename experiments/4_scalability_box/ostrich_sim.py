"""Helhest_junior box scalability benchmark — Ostrich, variable number of worlds.

Mirrors experiments/4_scalability/ostrich_sim.py but on the box scene + helhest
...
DT = 0.10              # Ostrich's exp-3-box default; ~12x realtime
...
class HelhestJuniorBoxScalabilityOptimizer(OstrichDifferentiableSimulator):
    """Ostrich-side replicated-worlds optimizer. One spline broadcast to all worlds."""
